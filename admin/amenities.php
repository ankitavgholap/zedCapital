            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <?php echo $_SESSION['company'] ?> Amenties Details
                                <a href="amenitiCreate.php" button style="float:right" type="button" class="btn btn-success btn-sm"> + Create Amenity</button></a>
                            </h2>
                        </div>
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                        <tr>
                                            ...
                                            <td><?php if($row['type']==1) echo "Modern"; else echo "Internal"; ?></td>
                                            <td><img src="<?php echo $row['icon']; ?>" alt="" height="50px" width="50px"></td>
                                            <td><?php if($row['status']==1) echo "Active"; else echo "Inactive"; ?></td>
                                            <td><?php echo $row['created_at']; ?></td>
                                            <td><?php echo $row['updated_at']; ?></td>
                                            <td><a  href="amenitiCreate.php?eid=<?php echo $row['id'];?>"button type="button" name="eid" class="btn btn-info">Edit</button></a>
									        <a href="amenitiSubmit.php?did=<?php echo $row['id'];?>" button type="button" class="btn btn-danger">Delete</button></a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
