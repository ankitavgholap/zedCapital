...
<body class="theme-blue-grey body-bg">
    ...
    <?php
      $sql = "SELECT * FROM `project_images` ORDER BY `id` DESC";    
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <a href="projectimageCreate.php" button style="float:right" type="button" class="btn btn-success btn-sm"> + Create Project Image</button></a>
                            </h2>
                        </div>
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                        <tr>
                                            ...
                                            <td><a  href="projectimageCreate.php?eid=<?php echo $row['id'];?>"button type="button" name="eid" class="btn btn-info">Edit</button></a>
									        <a href="projectimageSubmit.php?did=<?php echo $row['id'];?>" button type="button" class="btn btn-danger">Delete</button></a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
