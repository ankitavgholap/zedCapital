            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <?php echo $_SESSION['company'] ?> Create Location
                                <a href="locations.php" button style="float:right" type="button"
                       ...
                       <div class="body">
                           ...
                           <form class="rows" action="locationSubmit.php" method="post" enctype="multipart/form-data">
                                    <?php
                                        
                                        if(isset($_REQUEST['eid']))
                                        {
                                            $eid=$_GET['eid'];
                                            $result=mysqli_query($db,"select * from locations where id=$eid");
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" id="name" placeholder="Name" value="<?php if(isset($single)) echo  $single['name'] ?>"class="form-control" required>
                                </div>
                            ...
                            if(isset($single)){ ?>
                                    ...
                                    <div class="col-md-4">
                                        <input type="file" name="mob_banner" id="mob_banner" >
                                ...
                                <?php 
                                    ...
                                    <div class="col-md-4">
                                        <input type="file" name="mob_banner" id="mob_banner" required >
                                    </div>
                              <?php  
                            }?>                   
                            ...
                            if(isset($single)){ ?>
                                ...
                                <div class="col-md-4">
                                <input type="file" name="desk_banner" id="desk_banner" >
                                ...
                                <div class="col-md-4">
                                    <input type="file" name="desk_banner" id="desk_banner" required>                               
                                </div> 
                                <?php 
                            } ?>
                                ...
                                <div class="row text-center">
                                        ...
                                        ?>
                                            ...
                                            <button style="margin-top:20px; margin-bottom:20px;" type="submit"
                                                name="edit" class="btn btn-primary">Edit Location</button>
                                            <?php 
                                        }
                                        else
                                        { 
                                        ?>
                                            <button style="margin-top:20px; margin-bottom:20px;" type="submit"
                                                name="insert" class="btn btn-success">Create location</button>
                                        <?php 
                                        } ?>
