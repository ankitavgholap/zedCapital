            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <?php echo $_SESSION['company'] ?> Location Details
                                <a href="locationCreate.php" button style="float:right" type="button" class="btn btn-success btn-sm"> + Create Location</button></a>
                            </h2>
                        </div>
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                        <tr>
                                            ...
                                            <td><a  href="locationCreate.php?eid=<?php echo $row['id'];?>"button type="button" name="eid" class="btn btn-info">Edit</button></a>
									        <a href="locationSubmit.php?did=<?php echo $row['id'];?>" button type="button" class="btn btn-danger">Delete</button></a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
